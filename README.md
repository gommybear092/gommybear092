...
대한민국 서울시에서 일하고 있는 웹퍼블리셔 이문영 입니다. 저는 웹에이전시에서 3년 3개월 정도의 경력을 가지고 있으며, 반응형 웹사이트를 구축 또는 리뉴얼, 유지보수 하는 일을 주로 진행해왔습니다. 웹 표준 준수, 크로스 브라우징 대응, 웹 접근성, 웹 최적화 등을 고려하여 사용자에게 최적의 웹 환경을 제공하기 위해 노력합니다. 최근 회사 내부문제로 쉬게 되면서 현재는 새로운 일자리를 찾고 있습니다. 좋은 인연을 또 만나길 기다리고 있습니다. 잘 부탁드립니다 :) 🌸🍀

<!--
  <a href="https://gommye.tistory.com/"><img src="https://img.shields.io/badge/@gommye-ff5500?style=flat-square&amp;labelColor=ff5500&amp;logo=Tistory&amp;link=https://gommye.tistory.com/" alt="Tistory Badge"></a>
...
[![Gmail Badge](https://img.shields.io/badge/-@gommybear092-c14438?style=social&logo=Gmail&logoColor=red&link=mailto:email@gommybear092)](mailto:email@gommybear092)
[![LinkedIn Badge](https://img.shields.io/badge/-@gommybear092-blue?style=social&logo=Linkedin&logoColor=blue&link=https://www.linkedin.com/in/gommybear092/)](https://www.linkedin.com/in/gommybear092/)



## 👩‍💻 ABOUT ME
- 웹에이전시 퍼블리싱 경력 3년 3개월

- 반응형 웹사이트 구축 또는 리뉴얼, 유지보수
  
- 자세한 경력기술서는 <a href="http://" target="_blank">더보기</a>

- 서양화과 전공, 기본적인 디자인 감각
  
- 웹디자인~프론트, 상상하는 웹사이트를 내가 구축 할 수 있을때까지.
  
- 좋은 사람을 만나기 위해 먼저 내가 좋은 사람이 되자. 팀원들과 긍정적 에너지 교류
  
- 건강은 자기관리의 기본, 수영으로 다져진 체력
...
- 2024 포트폴리오 제작예정... comming soon! [👉Repository](https://)

- Javascript playground  [👉Repository](https://)
<hr>  
...
- 자세한 내용은 <a href="http://test" target="_blank">더보기</a>

### 1. 사내 Admin(php)을 사용하여 신규사이트 구축
입사 후 1년여간 서브페이지 퍼블리싱 작업을 맡아서 작업하였고, 2년차부터는 메인도 추가적으로 맡아서 작업하게 되었습니다. 보통 퍼블리싱팀 팀장이 판단하에 페이지 양이 많거나 기한이 짧은 경우 팀장이 메인을 맡고 제가 서폿하는 형식으로 작업하였고, 그 외에 혼자 할만한 스케일의 경우 저에게 맡겨 작업을 진행하도록 하였습니다.

#### - 메인 + 서브 100% (Main)
> [한국섬유수출입협회](http://textra.or.kr/) / [코드비전](https://codevision.kr/) / [노틀담수녀회](http://www.notredame.or.kr/) / [제때물류](https://jette.co.kr/) / [서울대학교 의료인공지능융합인재양성사업단](http://snuaimed.org/) / [귀뚜라미환경테크](https://kituramiet.com/)
<!--
> [제때물류](https://jette.co.kr/)<br>
> [서울대학교 의료인공지능융합인재양성사업단](http://snuaimed.org/)<br>
> [귀뚜라미환경테크](https://kituramiet.com/)<br>
> 코스모비, 캡스톤파트너스, ktextra, 나우CM, 에너지컨설팅, 케이디엔지니어링, SMI, 호현FnC, BS정보기술, 법무법인 시공 등
-->

#### - 서브 100% (Support)
> [포스코청암재단](https://postf.org/) / [연세대학교 이과대학](http://scienceyonsei.kr/) / [한솔로지스틱스](https://www.hansollogistics.com/)<br>
<!--
> [ESR캔달스쿼츠](https://www.esrks-reit.com/)<br>
> 서울시체육회, ktextile, 청담글로벌, apk, 가평화조원, MMT, SY탱크터미널, BRC, 라이팩, 위더스애드, MBRC 등
-->
<!-- 표 버전 
| 💪 **Role** | 🚀 **Projects** |
| - | - | 
...
### 2. 프론트만 개발하여 신규사이트 구축
백엔드 없이 오로지 html을 통해 페이지별로 파일을 만들어 프론트쪽만 개발하여 업체에 전달

#### - 서브 100% (Support)
> [위세아이텍](http://www.wise.co.kr/) / [코베네프](https://www.gobiztown.com/)
<!-- 표버전 
| 💪 **Role** | 🚀 **Projects** |
| - | - | 
